...
try {
  ...
  // -------------------------------------------------
  // FIRST: TRY AUTHENTICATED DB CART
  // -------------------------------------------------
...
if (loading) {
return ( <main className="flex min-h-screen items-center justify-center bg-[#09090b]"> <div className="flex flex-col items-center gap-4"> <Loader2
         size={40}
...
if (error || !product) {
return ( <main className="flex min-h-screen items-center justify-center bg-[#09090b] px-4"> <div className="max-w-md rounded-3xl border border-zinc-800 bg-zinc-900 p-8 text-center"> <PackageOpen
         size={52}
...
return ( <main className="min-h-screen bg-[#09090b] text-white"> <div className="mx-auto w-full max-w-[1500px] px-4 py-6 sm:px-6 lg:px-8">
